...
public class CordovaHttpPostJsonAlba extends CordovaHttp implements Runnable {
    
    public CordovaHttpPostJsonAlba(String urlString, String jsonObj, Map<String, String> headers, CallbackContext callbackContext) {
    ...
    public void run() {
        try {
            ...
            request.send(getJsonObjectString());
