...
var http = {
	...
	postJsonAlba: function(url, json, headers, success, failure) {
        return exec(success, failure, "CordovaHttpPlugin", "postJsonAlba", [url, json, headers]);
    },
...
if (typeof angular !== "undefined") {
    angular.module('cordovaHTTP', []).factory('cordovaHTTP', function($timeout, $q) {
        ...
        var cordovaHTTP = {
			...
			postJsonAlba: function(url, json, headers) {
                return makePromise(http.postJson, [url, json, headers], true);
            },
